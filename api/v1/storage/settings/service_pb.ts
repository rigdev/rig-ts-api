...
import { Settings } from "./storage_pb.js";

/**
 * @generated from message api.v1.storage.settings.GetSettingsRequest
 */
export class GetSettingsRequest extends Message<GetSettingsRequest> {
  ...
  static readonly typeName = "api.v1.storage.settings.GetSettingsRequest";
...
/**
 * @generated from message api.v1.storage.settings.GetSettingsResponse
 */
export class GetSettingsResponse extends Message<GetSettingsResponse> {
  /**
   * @generated from field: api.v1.storage.settings.Settings settings = 1;
   */
  settings?: Settings;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.v1.storage.settings.GetSettingsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message api.v1.storage.settings.UpdateSettingsRequest
 */
export class UpdateSettingsRequest extends Message<UpdateSettingsRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.v1.storage.settings.UpdateSettingsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message api.v1.storage.settings.UpdateSettingsResponse
 */
export class UpdateSettingsResponse extends Message<UpdateSettingsResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.v1.storage.settings.UpdateSettingsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
