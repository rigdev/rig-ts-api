...
// @generated from file api/v1/issue/issue.proto (package api.v1.issue, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from enum api.v1.issue.Level
 */
export enum Level {
  /**
...
proto3.util.setEnumType(Level, "api.v1.issue.Level", [
...
/**
 * @generated from message api.v1.issue.Issue
 */
export class Issue extends Message<Issue> {
  ...
  /**
   * @generated from field: api.v1.issue.Reference reference = 6;
   */
  reference?: Reference;
  ...
  /**
   * @generated from field: api.v1.issue.Level level = 8;
   */
  ...
  static readonly typeName = "api.v1.issue.Issue";
...
/**
 * @generated from message api.v1.issue.Reference
 */
export class Reference extends Message<Reference> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.v1.issue.Reference";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
