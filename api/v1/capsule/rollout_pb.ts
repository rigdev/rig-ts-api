...
export class Change extends Message<Change> {
  ...
  field: {
    ...
    /**
     * @generated from field: api.v1.capsule.CronJobs cron_jobs = 10;
     */
    value: CronJobs;
    case: "cronJobs";
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 10, name: "cron_jobs", kind: "message", T: CronJobs, oneof: "field" },
  ]);
...
/**
 * @generated from message api.v1.capsule.CronJobs
 */
export class CronJobs extends Message<CronJobs> {
  /**
   * @generated from field: repeated api.v1.capsule.CronJob jobs = 1;
   */
  jobs: CronJob[] = [];

  constructor(data?: PartialMessage<CronJobs>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.v1.capsule.CronJobs";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "jobs", kind: "message", T: CronJob, repeated: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): CronJobs {
    return new CronJobs().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): CronJobs {
    return new CronJobs().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): CronJobs {
    return new CronJobs().fromJsonString(jsonString, options);
  }

  static equals(a: CronJobs | PlainMessage<CronJobs> | undefined, b: CronJobs | PlainMessage<CronJobs> | undefined): boolean {
    return proto3.util.equals(CronJobs, a, b);
  }
}
