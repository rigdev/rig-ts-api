...
/**
 * @generated from message api.v1.capsule.PromoteRequest
 */
export class PromoteRequest extends Message<PromoteRequest> {
  /**
  ...
  /**
   * if true, the promotion will not be executed, but the request will return
   * the rollout config.
   *
  ...
  constructor(data?: PartialMessage<PromoteRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.v1.capsule.PromoteRequest";
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): PromoteRequest {
    return new PromoteRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): PromoteRequest {
    return new PromoteRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): PromoteRequest {
    return new PromoteRequest().fromJsonString(jsonString, options);
  }

  static equals(a: PromoteRequest | PlainMessage<PromoteRequest> | undefined, b: PromoteRequest | PlainMessage<PromoteRequest> | undefined): boolean {
    return proto3.util.equals(PromoteRequest, a, b);
  }
}

/**
 * @generated from message api.v1.capsule.PromoteResponse
 */
export class PromoteResponse extends Message<PromoteResponse> {
  /**
   * @generated from field: api.v1.capsule.DeployResponse deploy_response = 1;
   */
  deployResponse?: DeployResponse;

  constructor(data?: PartialMessage<PromoteResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.v1.capsule.PromoteResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "deploy_response", kind: "message", T: DeployResponse },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): PromoteResponse {
    return new PromoteResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): PromoteResponse {
    return new PromoteResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): PromoteResponse {
    return new PromoteResponse().fromJsonString(jsonString, options);
  }

  static equals(a: PromoteResponse | PlainMessage<PromoteResponse> | undefined, b: PromoteResponse | PlainMessage<PromoteResponse> | undefined): boolean {
    return proto3.util.equals(PromoteResponse, a, b);
  }
}
