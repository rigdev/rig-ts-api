...
export enum State {
  ...
  /**
   * @generated from enum value: STATE_DEPLOYING = 2;
   */
  DEPLOYING = 2,
  ...
  /**
   * @generated from enum value: STATE_ABORTED = 4;
   */
  ABORTED = 4,
...
proto3.util.setEnumType(State, "api.v1.capsule.rollout.State", [
  ...
  { no: 2, name: "STATE_DEPLOYING" },
  { no: 3, name: "STATE_RUNNING" },
  { no: 4, name: "STATE_ABORTED" },
  { no: 5, name: "STATE_DONE" },
]);

/**
 * @generated from enum api.v1.capsule.rollout.ConfigureState
 */
export enum ConfigureState {
  /**
   * @generated from enum value: CONFIGURE_STATE_UNSPECIFIED = 0;
   */
  UNSPECIFIED = 0,

  /**
   * @generated from enum value: CONFIGURE_STATE_CREATED = 1;
   */
  CREATED = 1,

  /**
   * @generated from enum value: CONFIGURE_STATE_UPDATED = 2;
   */
  UPDATED = 2,

  /**
   * @generated from enum value: CONFIGURE_STATE_NO_CHANGE = 3;
   */
  NO_CHANGE = 3,
}
// Retrieve enum metadata with: proto3.getEnumType(ConfigureState)
proto3.util.setEnumType(ConfigureState, "api.v1.capsule.rollout.ConfigureState", [
  { no: 0, name: "CONFIGURE_STATE_UNSPECIFIED" },
  { no: 1, name: "CONFIGURE_STATE_CREATED" },
  { no: 2, name: "CONFIGURE_STATE_UPDATED" },
  { no: 3, name: "CONFIGURE_STATE_NO_CHANGE" },
]);
...
export class ConfigureCapsuleStep extends Message<ConfigureCapsuleStep> {
  ...
  /**
   * @generated from field: api.v1.capsule.rollout.ConfigureState state = 2;
   */
  state = ConfigureState.UNSPECIFIED;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "info", kind: "message", T: StepInfo },
    { no: 2, name: "state", kind: "enum", T: proto3.getEnumType(ConfigureState) },
  ]);
...
export class ResourceCreationStep extends Message<ResourceCreationStep> {
  ...
  step: {
    ...
    /**
     * @generated from field: api.v1.capsule.rollout.ResourceCreation resource_creation = 2;
     */
    value: ResourceCreation;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "generic", kind: "message", T: GenericStep, oneof: "step" },
    { no: 2, name: "resource_creation", kind: "message", T: ResourceCreation, oneof: "step" },
  ]);
...
/**
 * @generated from message api.v1.capsule.rollout.ResourceCreation
 */
export class ResourceCreation extends Message<ResourceCreation> {
  /**
   * @generated from field: api.v1.capsule.rollout.StepInfo info = 1;
   */
  info?: StepInfo;
  ...
  constructor(data?: PartialMessage<ResourceCreation>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.v1.capsule.rollout.ResourceCreation";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "info", kind: "message", T: StepInfo },
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ResourceCreation {
    return new ResourceCreation().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ResourceCreation {
    return new ResourceCreation().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ResourceCreation {
    return new ResourceCreation().fromJsonString(jsonString, options);
  }

  static equals(a: ResourceCreation | PlainMessage<ResourceCreation> | undefined, b: ResourceCreation | PlainMessage<ResourceCreation> | undefined): boolean {
    return proto3.util.equals(ResourceCreation, a, b);
  }
}
