...
export enum PathMatchType {
  /**
   * @generated from enum value: PATH_MATCH_TYPE_UNSPECIFIED = 0;
   */
  UNSPECIFIED = 0,

  /**
   * @generated from enum value: PATH_MATCH_TYPE_PATH_PREFIX = 1;
   */
  PATH_PREFIX = 1,
...
export class Interface extends Message<Interface> {
   ...
   *
   * @generated from field: repeated api.v1.capsule.HostRoute routes = 9;
   */
  routes: HostRoute[] = [];
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 9, name: "routes", kind: "message", T: HostRoute, repeated: true },
  ]);
...
/**
 * @generated from message api.v1.capsule.HostRoute
 */
export class HostRoute extends Message<HostRoute> {
  ...
  /**
   * @generated from field: api.v1.capsule.RouteOptions options = 2;
   */
  options?: RouteOptions;

  /**
   * @generated from field: repeated api.v1.capsule.HTTPPathRoute paths = 3;
   */
  paths: HTTPPathRoute[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.v1.capsule.HostRoute";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message api.v1.capsule.HTTPPathRoute
 */
export class HTTPPathRoute extends Message<HTTPPathRoute> {
  ...
  /**
   * @generated from field: api.v1.capsule.PathMatchType match = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.v1.capsule.HTTPPathRoute";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "path", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message api.v1.capsule.RouteOptions
 */
export class RouteOptions extends Message<RouteOptions> {
  /**
   * @generated from field: map<string, string> annotations = 1;
   */
  annotations: { [key: string]: string } = {};

  constructor(data?: PartialMessage<RouteOptions>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.v1.capsule.RouteOptions";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "annotations", kind: "map", K: 9 /* ScalarType.STRING */, V: {kind: "scalar", T: 9 /* ScalarType.STRING */} },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): RouteOptions {
    return new RouteOptions().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): RouteOptions {
    return new RouteOptions().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): RouteOptions {
    return new RouteOptions().fromJsonString(jsonString, options);
  }

  static equals(a: RouteOptions | PlainMessage<RouteOptions> | undefined, b: RouteOptions | PlainMessage<RouteOptions> | undefined): boolean {
    return proto3.util.equals(RouteOptions, a, b);
  }
}
